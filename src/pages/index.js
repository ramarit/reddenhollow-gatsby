...
export default function Home() {
  return (
    ...
    <div className="background images"><img src={background} alt="haunt me" /></div>
    ...
    <ul className="navigation">
        ...
        <li><Link to="/lyrics"><p className="fromRight">lyrics</p></Link></li>
    ...
    <div className="cutout"><img src={cutout} alt="cutout" /></div>
  ...
  <div id="music" className="embed"><Iframe iframeSrcURL="https://bandcamp.com/EmbeddedPlayer/album=1462305287/size=large/bgcol=ffffff/linkcol=0687f5/artwork=small/transparent=true/" /></div>
